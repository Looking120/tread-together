...
const StatisticBox = styled(Box)(({ theme }) => ({
  ...
  flex: '1 1 100%', // Sur les petits écrans, chaque élément prend la pleine largeur
  [theme.breakpoints.up('sm')]: {
    flex: '1 1 20%', // Sur les écrans moyens et plus, chaque élément prend environ 20% de la largeur
  },
}));

export default function ProfileStatistics({ profileView, impressionsPost, apparitionsRecherche, interactions, viewsVideo }) {
  const stats = [
    {
